        ...
        <div class="container_carousel">
                ...
                <div class="carousel">
                    <article class="main_carousel-scroll">
                        <img src="recursos/academico-certificados.png" alt="desarrollo de negocios esports">
                        <div>
                            <h3>desarrollo de negocios esports</h3>
                            <p class="epigrafe">Inicio el Abril 2023 con modalidad virtual.</p>
                            <p class="mobile">Vas a aprender a desenvolverte en la industria de deportes electrónicos de una manera eficiente y proactiva</p>
                            <p class="desktop">Vas a aprender a desenvolverte en la industria de deportes electrónicos de una manera eficiente y proactiva, ya sea desde tu área de conocimiento aplicada a ESPORTS o abordando nuevos campos.  Y se brindaran herramientas y una mirada objetiva de la realidad de los ESPORTS en la región para saber con qué barreras pueden encontrarse y cómo enfrentarlas en este contexto.</p>
...
<!-- Contenido específico -->
        ...
        <div id="tarjeta_negro-academico" class="desktop">
            ...
            <div class="container_programa_v1">
            ...
            <div class="container_programa_v1">
                ...
                <article>
                    ...
                    <p class="epigrafe">duración: 13 meses</p>
        ...
        <div id="tarjeta_negro-academico" class="mobile">
            <h2>investigaciones</h2>
            <article id="box_academico">
                <div class="text_box">
                    <h2>dirección de formación e investigación científica</h2> 
...
<!-- Hasta acá el contenido específico --> 
        ...
        <div class="main_galeria-carousel">
            ...
            <div>
                ...
                <img src="recursos/academico-galeria-izquierda.png" alt="" class="mobile">
                    <ul class="fotos">

                        <li class="desktop"><img src="recursos/academico-galeria-izquierda.png" alt=""></li>
                        <li class="desktop"><img src="recursos/academico-galeria-centro.png" alt=""></li>
                        <li class="desktop"><img src="recursos/academico-galeria-derecha.png" alt=""></li>
                    </ul>     
            </div>
        </div>
...
>>>>>>> 82b3a0ff0a0aca34982cd526ef04e9782de53c05
</html>